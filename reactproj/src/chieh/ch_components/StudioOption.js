          ...
          <div className="option-action d-flex flex-wrap justify-content-between">           
            <Accordion>                
              <Card.Header className="d-flex flex-wrap justify-content-between">
                <span style={{fontSize : '2rem', fontWeight:'bold', fontFamily:'Roboto'}}>NT$ {option.slice(4,8)}</span>
                ...
                <Card.Body>
                  ...
                  <div className="d-flex align-items-center justify-content-end mb-3">
                    <div className="mr-4">總金額</div>
                      <div style={{color:'#2690df', fontWeight:'bold', fontSize:'1.5rem', fontFamily:'Roboto'}}>NT$ {option.slice(4,8)}</div>
                    </div>
